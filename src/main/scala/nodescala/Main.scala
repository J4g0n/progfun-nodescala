...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val myServerSubscription = myServer.start("/home") {
      request => "Have a nice day!".split(" ").iterator
    }
    ...
    val timeOut: Future[String] = {
      Future.delay(60 seconds).continue {
        tryUnit => "Server timeout!"
      }
    }
